...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Aitoc\OrdersExportImport\Model\Import::class,
            \Aitoc\OrdersExportImport\Model\ResourceModel\Import::class
        );
    }

    /**
     * Add ready to import filter to collection
     *
     * @return $this
     */
    public function readyForImportFilter()
    {
