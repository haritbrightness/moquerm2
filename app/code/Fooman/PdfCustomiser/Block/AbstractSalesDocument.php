...
abstract class AbstractSalesDocument extends \Fooman\PdfCore\Block\Pdf\DocumentRenderer
{
     ...
     * @param \Fooman\PdfCustomiser\Model\DesignProvider            $designProvider
     * @param \Fooman\PdfCustomiser\Model\TemplateFileDecider       $templateFileDecider
     * @param array                                                 $data
     */
    ...
    {
        $block = $this->getLayout()->createBlock(
            \Fooman\PdfCustomiser\Block\DesignOne\Icons::class,
