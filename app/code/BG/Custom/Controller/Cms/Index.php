...
namespace BG\Custom\Controller\Cms;

class Index extends \Sm\Market\Controller\Cms\Index
{
    ...
    {	
		...
		if ($deviceType == 'computer'){
			...
			$resultPage = $this->_objectManager->get('Magento\Cms\Helper\Page')->prepareResultPage($this, $home_pageId);
