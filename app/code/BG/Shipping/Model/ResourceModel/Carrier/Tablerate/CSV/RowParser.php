...
namespace BG\Shipping\Model\ResourceModel\Carrier\Tablerate\CSV;
...
class RowParser extends \Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\RowParser
{
    ...
    public function parse(
        ...
        $eta = $this->getETA($rowData, $rowNumber, $columnResolver);
    ...
    /**
     * Get eta from provided row data.
     *
     * @param array $rowData
     * @param int $rowNumber
     * @param ColumnResolver $columnResolver
     ...
     * @throws RowException
     */
    private function getETA(array $rowData, $rowNumber, ColumnResolver $columnResolver)
    {
        $etaValue = $columnResolver->getColumnValue(ColumnResolver::COLUMN_ETA, $rowData);
        return $etaValue;
    }
}
