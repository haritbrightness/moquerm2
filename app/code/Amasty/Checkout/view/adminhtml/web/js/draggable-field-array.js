define([
    ...
    $.widget('mage.amastyDraggableFieldArray', {
        options: {
            ...
            checkoutDesignSelect: '#amasty_checkout_design_checkout_design',
            checkoutLayoutSelect: '#amasty_checkout_design_layout_modern',
