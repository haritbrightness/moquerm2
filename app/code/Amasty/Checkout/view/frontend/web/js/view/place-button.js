        ...
        return Component.extend({
            ...
            initObservable: function () {
                this._super().observe({
                    ...
                    isAmazonLoggedIn: true
                });
                quote.paymentMethod.subscribe(this.updateLabel.bind(this));
                quote.paymentMethod.subscribe(this.hidePlaceOrderButton.bind(this));
            ...
            // hide place order button, if customer checked amazon payment and not logged in
            hidePlaceOrderButton: function(payment) {
                if (payment && payment.method === 'amazonlogin') {
                    require(['Amazon_Payment/js/model/storage'], function (amazonStorage) {
                        if (!amazonStorage.isAmazonAccountLoggedIn()) {
                            this.isAmazonLoggedIn(false);
                        }
                    }.bind(this));
                } else {
                    this.isAmazonLoggedIn(true);
                }
            },
