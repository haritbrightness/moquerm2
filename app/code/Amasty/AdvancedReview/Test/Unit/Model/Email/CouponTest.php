...
class CouponTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getCouponMessageDataProvider()
    {
        return [
            ...
            And please kindly keep in mind, that you will receive a discount coupon after your 
            review is approved.'
            ],
            [
                false,
            ...
            [
                ...
                false,
                'It will take only a few minutes, just click the \'Leave a review\' button below. 
            which can already be used for your next purchase. Here it is: CouponCode (please kindly keep in mind that it will expire in 5 days).',
                'CouponCode',
                '5',
