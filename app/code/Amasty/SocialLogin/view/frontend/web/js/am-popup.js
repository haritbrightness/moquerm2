    ...
    $.widget('mage.amLoginPopup', {
        ...
        options: {
            selectors: {
                ...
                resetPassword: '.am-forgot-content form.forget',
        ...
        resetPasswordRequest: function (form) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.error) {
                        var errorBlock = $(form).parents('.am-content').find('[data-am-js="am-default-error"]');
                        $(errorBlock).show().html(response.error);
                    } else if (response.success) {
                        $(self.options.selectors.tabWrapperForgot).hide();
                        $(self.options.selectors.contentWrapper)
