...
class ConfigProvider
{
    ...
    const ALLOW_UNREGISTERED_CUSTOMER_ASK  = 'amastyfaq/general/unregistered_customers_questions';
    ...
    const SHOW_TAB_ON_PRODUCT_PAGE = 'amastyfaq/product_page/show_tab';
    ...
    const TAG_MENU_LIMIT = 'amastyfaq/faq_page/tag_menu_limit';

    const TAB_NAME = 'amastyfaq/product_page/tab_name';

    const TAB_POSITION = 'amastyfaq/product_page/tab_position';
     ...
     * @return bool
     */
    public function isAllowUnregisteredCustomersAsk($scopeType = ScopeInterface::SCOPE_STORE)
    {
        return (bool)$this->getValue(self::ALLOW_UNREGISTERED_CUSTOMER_ASK, $scopeType);
    }
     ...
     * @return string
     */
    public function getNotifySender($storeId = null, $scopeType = ScopeInterface::SCOPE_STORE)
    {
        return $this->getValue(self::USER_NOTIFY_SENDER, $scopeType, $storeId);
    }
     ...
     * @return int
     */
    public function getTagMenuLimit($scopeType = ScopeInterface::SCOPE_STORE)
    {
        return (int)$this->getValue(self::TAG_MENU_LIMIT, $scopeType);
    }
     ...
     * @return string
     */
    public function getTabName($scopeType = ScopeInterface::SCOPE_STORE)
    {
        return $this->getValue(self::TAB_NAME, $scopeType);
    }
     ...
     * @return int
     */
    public function getTabPosition($scopeType = ScopeInterface::SCOPE_STORE)
    {
        return (int)$this->getValue(self::TAB_POSITION, $scopeType);
    }
     ...
     * @return bool
     */
    public function isShowTab($scopeType = ScopeInterface::SCOPE_STORE)
    {
        return (bool)$this->getValue(self::SHOW_TAB_ON_PRODUCT_PAGE, $scopeType);
    }
}
